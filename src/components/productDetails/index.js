...
import Category from '../features/category.component';
					...
					<div className="product-details">
						...
						<div className="col-sm-7">
							<div className="product-information">
								<img src="images/product-details/rating.png" className="newarrival" alt="" />
								<h2>{users[id].name}</h2>
								<p>Web ID: {users[id].id}</p>
								<img src="images/product-details/new.jpg" alt="" />
								<span>
									<span>US ${users[id].price}</span>
									<label>Quantity:</label>
									<input type="text" value="3" />
									<Link to={`/cart/${id}`}> <button  type="button" className="btn btn-fefault cart">
